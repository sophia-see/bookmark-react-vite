    ...
    return (
        <div className="feature__details">
            ...
            <div className="content">
                ...
                <div className="subheading-1 mb-16">Organize your bookmarks however you like. Our simple drag-and-drop interface gives you complete control over how you manage your favourite sites.</div>
